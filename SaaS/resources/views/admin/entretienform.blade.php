...
<div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-4xl">
    <h1 class="text-2xl font-bold text-gray-800 mb-4 text-center">Formulaire de création d'un entretien</h1>

    <form action="{{route('admin.entretien.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
